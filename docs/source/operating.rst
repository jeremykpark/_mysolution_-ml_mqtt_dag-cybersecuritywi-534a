[_mysolution_-ml_mqtt_dag-cybersecuritywi-534a] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [_mysolution_-ml_mqtt_dag-cybersecuritywi-534a] container is NOT running**.

.. tip::
   You must have your [_mysolution_-ml_mqtt_dag-cybersecuritywi-534a] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/jeremykpark/tml-raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  -v /your_localmachine/foldername:/rawdata:z  \-\-env GITREPOURL=https://github.com/jeremykpark/tml-raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=9010  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='jeremykpark'  \-\-env DOCKERUSERNAME='jeremykpark'  \-\-env MQTTUSERNAME='tsstestcluser234'  \-\-env KAFKACLOUDUSERNAME='KV4GV4NF2H33GAPT'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  \-\-env UPDATE=1  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:9005/?topic=&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
[_mysolution_-ml_mqtt_dag-cybersecuritywi-534a] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/jeremykpark/tml-raspberrypi/tree/main/tml-airflow/dags/tml-solutions/_mysolution_-ml_mqtt_dag-cybersecuritywi-534a
...
.. important::
   solution_preprocessing_ml_mqtt_dag-cybersecuritywithprivategpt-534a
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=43399, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=44365, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=39019, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=46219, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=34907, HPDEHOST=127.0.1.1, HPDEPORT=40127, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=33015

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-6026-_mysolution_-ml_mqtt_dag-cybersecuritywi-534a,solution_preprocessing_ml_mqtt_dag-cybersecuritywithprivategpt-534a, python-preprocess-7795-_mysolution_-ml_mqtt_dag-cybersecuritywi-534a,solution_preprocessing_ml_mqtt_dag-cybersecuritywithprivategpt-534a, python-ml-5344-_mysolution_-ml_mqtt_dag-cybersecuritywi-534a,solution_preprocessing_ml_mqtt_dag-cybersecuritywithprivategpt-534a, python-predict-4440-_mysolution_-ml_mqtt_dag-cybersecuritywi-534a,solution_preprocessing_ml_mqtt_dag-cybersecuritywithprivategpt-534a, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
